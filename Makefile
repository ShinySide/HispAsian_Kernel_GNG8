...
PATCHLEVEL = 4
SUBLEVEL = 0
EXTRAVERSION = _HispAsian_Kernel_
...
ARCH		?= arm
CROSS_COMPILE	?= /home/adam0524/Android/linaro_toolchains_2014/arm-cortex_a15-linux-gnueabihf-linaro_4.9.1-2014.07/bin/arm-cortex_a15-linux-gnueabihf-

# Architecture as present in compile.h
UTS_MACHINE 	:= $(ARCH)
SRCARCH 	:= $(ARCH)

# Additional ARCH settings for x86Linaro-GCC
ifeq ($(ARCH),i386)
        SRCARCH := x86
endif
ifeq ($(ARCH),x86_64)
